...
<div>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <div>
                    <h1 style="font-weight: bolder;">{{$national->headline}}</h1>
                </div>
                <div class="d-flex">
                    @foreach($authors as $author)
                    <div>
                        @if($author->id == $national->posted_by)
                    ...
                    @endforeach
                    <div class="px-2">
                        <small style="font-weight:100; font-size: xx-small;">{{ \Carbon\Carbon::parse($national->created_at)->toRfc850String()}}</small>
                    </div>
                </div>                                         
                <div class="py-3">
                    <div class="con">
                ...
                <div class="py-3">
                    <p class="h6" style="white-space: pre-wrap;">{{$national->story_one}}</p>
                </div>
                @if ($national->url != null)
                    <div class="py-3">
                        <div class="embed-responsive ratio ratio-16x9">
                            <iframe src="https://www.youtube.com/embed/{{$national->url}}" frameborder="0"></iframe>
                        </div>
                    </div>
                 @endif
                 @if ($national->story_two != null)
                    <div class="py-3">
                        <p class="h6" style="white-space: pre-wrap;">{{$national->story_two}}</p>
                    </div>
                @endif
                <div class="py-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" >
                            <div style="background: white;">
                                ...
                                <a href="{{route('national.show',$news->headline)}}" class="h4 headline">
